...
class RouterContextValue {
    ...
    /**
     * Crea una instancia de la clase RouterContextValue.
     *
     * @param {object} options - Opciones de configuración para la clase RouterContextValue.
    ...
    constructor({ pushStateFn, replaceStateFn }) {
        if (typeof pushStateFn !== 'function') {
            throw new Error('El constructor de RouterContextValue requiere una función "pushStateFn".');
        }
        if (typeof replaceStateFn !== 'function') {
            throw new Error('El constructor de RouterContextValue requiere una función "replaceStateFn".');
        }
...
export default RouterContextValue;
