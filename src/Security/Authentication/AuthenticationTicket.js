...
/**
 * Representa un ticket de autenticación que encapsula la identidad
...
class AuthenticationTicket {
    /**
     * El objeto `ClaimsPrincipal` que representa la identidad del usuario autenticado.
     * @type {ClaimsPrincipal}
     */
    #principal;

    /**
     * Las propiedades o metadatos asociados a este ticket de autenticación.
