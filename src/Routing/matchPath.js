/**
 * Utilidad para hacer coincidir rutas dinámicas con URLs reales y extraer sus parámetros.
 * Similar a la funcionalidad de routers como React Router, pero en forma minimalista.
 * 
 * @module matchPath
 */
