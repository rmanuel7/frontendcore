/**
 * Resuelve la coincidencia de rutas declaradas como elementos React (tipo árbol).
 * 
 * Evalúa contextos como autorización, controladores, layouts y vistas, devolviendo la estructura
 * resultante si hay coincidencia con la ubicación actual.
 *
 * @module matchRoute
 */
...
/**
 * Hace el matching de la ruta actual contra la definición de rutas, propagando contextos como autorización, layout, controller, etc.
