...
/**
 * Representa al poseedor de una identidad que también posee una colección de afirmaciones (claims).
 * 
...
class ClaimsPrincipal extends Principal {
    /**
     * Una colección de afirmaciones asociadas con este principal.
     * @type {Claim[]}
     */
    #claims;
